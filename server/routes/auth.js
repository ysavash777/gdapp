...
// PATCH /api/auth/password  { newPassword } — el propio usuario
// logueado cambia su contraseña. No pide la contraseña actual (pedido
// explícito) — la sesión ya autenticada es la única puerta.
